...
export const Navbar = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      const [almonds, raisins] = await Promise.all([
        fetch("https://ecommerece-nextjs-92b48-default-rtdb.firebaseio.com/products.json"),
        fetch("https://ecommerece-nextjs-92b48-default-rtdb.firebaseio.com/productRaisins.json"),
      ]);
